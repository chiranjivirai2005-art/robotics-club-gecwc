...
export default function AdminDashboard() {
  ...
  const dashboardLinks = [
    ...
    { title: "Inventory", description: "Manage stock, issuing, and returns", href: "/admin/inventory", icon: Boxes },
    { title: "Inventory Analytics", description: "Review stock health and usage insights", href: "/admin/inventory/dashboard", icon: ChartBar },
    { title: "Attendance QR", description: "Generate QR sessions and review attendance usage", href: "/admin/attendance", icon: QrCode },
